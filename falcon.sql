...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 21 mai 2024 à 17:40
...
(4, 'Maajabu', 'Gauthier', 'DG', '+243810614101', 'Kinshasa, c/Ngaliema, Q/ Macapagne', 'maajabu@gmail.com', 0, '2024-05-21 13:23:46');
...
(1, 1, '1', 2, NULL, '2024-05-17', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2024-05-16 15:43:09'),
(2, 1, '1', 2, 1, '2024-05-21', 1, 1, NULL, NULL, NULL, NULL, '/uploads/1fe577b4b3c3204bae0fa49f041f9320', '/uploads/e70d878e4b456f98055ae5e4c05dcb45', 0, '2024-05-20 13:58:20');
...
(2, '1', NULL, NULL, 'D201', 1, '2024-05-21 13:21:42', NULL, 0);
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','secretaire','superviseur','technicien') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Ndambi', 'achandambi@gmail.com', '$2a$10$lQti3gk3E4BcoCgLTogsFuw0nfn27fpmoPkzPyhfQl2O6ZlgbT5DG', 'admin'),
(2, 'grady', 'grady@gmail.com', '$2a$10$3srGJIRwrKAow/zwZXFHb.hZSynO0dppn/LDf2yi.3TXzkNZYJfLO', 'superviseur'),
(3, 'Guelord', 'guelord@gmail.com', '$2a$10$1sfijqJSsxQVk5WeUHdIP.Q0fxMIh1IYBDJZ8xKa84ZR1bC/nNirW', 'technicien');
...
INSERT INTO `vehicule` (`id_vehicule`, `id_marque`, `matricule`, `id_client`, `code`) VALUES
(2, 1, '23B12B', 3, NULL);
...
--
ALTER TABLE `traceur`
  MODIFY `id_traceur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
